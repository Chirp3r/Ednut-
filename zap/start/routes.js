...
Route.group(() => {
    ...
    Route.get('/create-invoice/:id','InvoiceController.create').as('create.invoice')
    Route.post('/store-invoice','InvoiceController.store').as('store.invoice').validator('Invoice')
